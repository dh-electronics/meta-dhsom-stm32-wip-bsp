...
`1-2-3-4-5-6=GND-NC-VCC-TX-RX-NC` , pin 1 is closer to board center.
...
To make configuration permanent, store U-Boot environment:
```
=> env save
```
...
to resolve eMMC card block device to `/dev/mmcblk0` device node manually by
